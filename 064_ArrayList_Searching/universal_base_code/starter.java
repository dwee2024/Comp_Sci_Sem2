...
class starter {
	...
	public static void searchArrInt(ArrayList<Integer> arr, int n) {
		for(int i = 0; i < arr.size(); i++) {
			if(arr.get(i) == n) {
		...
		System.out.println(n + " is not a vaule in this array");
		return;
	}
	public static void searchArrString(ArrayList<String> arr, String n) {
		for(int i = 0; i < arr.size(); i++) {
		...
		System.out.println(n + " is not a value in this array");
		return;
	}
}
